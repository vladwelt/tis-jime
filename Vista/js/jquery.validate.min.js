    ...
    a.extend(a.fn, {validate: function(b) {
        ...
        return 1 === arguments.length ? function() {
            ...
            a.extend(a.validator.defaults, b)
                ...
                }), a(this.currentForm).validateDelegate(":text, [type='password'], [type='file'], select, textarea, [type='number'], [type='literal'],[type='search'] ,[type='tel'], [type='url'], [type='email'], [type='datetime'], [type='date'], [type='month'], [type='week'], [type='time'], [type='datetime-local'], [type='range'], [type='color'] ", "focusin focusout keyup", b).validateDelegate("[type='radio'], [type='checkbox'], select, option", "click", b), this.settings.invalidHandler && a(this.currentForm).bind("invalid-form.validate", this.settings.invalidHandler), a(this.currentForm).find("[required], [data-rule-required], .required").attr("aria-required", "true")
            }, form: function() {
            ...
            a.validator.methods[b] = c, a.validator.messages[b] = void 0 !== d ? d : a.validator.messages[b], c.length < 3 && a.validator.addClassRules(b, a.validator.normalizeRule(b))
                ...
                return this.optional(b) || /^[a-zA-Záéíóúñ]+[ ]+[a-zA-Záéíóúñ]*$/.test(a) || /^[a-zA-Záéíóúñ]*$/.test(a) || /^[a-zA-Záéíóúñ]+[ ]+[a-zA-Záéíóúñ]+[ ]+[a-zA-Záéíóúñ]*$/.test(a)
            }, login: function(a, b) {
                return this.optional(b) || /^[a-zA-Z0-9áéíóúñ]*$/.test(a)
            },
