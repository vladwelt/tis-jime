...
(function ( $ ) {
	...
	var tocalendar = function() {
		...
		for(var o = 0; o<ev.length;o++) {
                    ...
                    {
                        $(".specific-day-scheme").append('<div class="specific-day-scheme-event"><a href= "../Vista/iuTablaSeguimientoDocenteGE.php?a='+ev[o]['location']+'&b='+ev[o]['codigo']+'"><h1>'+ev[o]['name']+'</h1></a><p data-role="dur">'+ev[o]['start']+' '+ev[o]['end']+'</p><p data-role="loc"></p><p data-role="cod"></p></div>');
